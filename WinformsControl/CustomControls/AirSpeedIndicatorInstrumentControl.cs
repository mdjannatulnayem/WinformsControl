...
namespace WinformsControl.CustomControls
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.AirSpeedNeedle);
