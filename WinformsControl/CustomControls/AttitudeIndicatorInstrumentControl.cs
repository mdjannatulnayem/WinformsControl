...
namespace WinformsControl.CustomControls
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.Maquette_Avion);
