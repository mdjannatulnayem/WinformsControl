...
namespace WinformsControl.CustomControls
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.HeadingIndicator_Aircraft);
