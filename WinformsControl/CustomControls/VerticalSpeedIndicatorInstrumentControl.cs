...
namespace WinformsControl.CustomControls
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(WinformsControl.CustomControls.AvionicsInstrumentsControlsRessources.VerticalSpeedNeedle);
